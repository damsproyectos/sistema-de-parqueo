...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="<!?php echo $URL;?>/login/cerrar_sesion.php" class="nav-link">Cerrar Session</a>
      </li-->
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/principal.php" class="brand-link">
      <!--img src="<!?php echo $URL;?>/app/templeates/AdminLTE-3.2.0/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"-->
      <img src="<?php echo $URL;?>/public/imagenes/auto1.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
